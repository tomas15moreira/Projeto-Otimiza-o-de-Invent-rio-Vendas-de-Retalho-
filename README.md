...
2. **Dados externos:** Integrar fatores que o modelo atual não conhece, como dados meteorológicos, eventos locais, férias escolares ou a localização geográfica das lojas, que ajudam a explicar variações nas vendas que o histórico, por si só, não justifica.
